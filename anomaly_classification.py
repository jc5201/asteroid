   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "100%|██████████████████████████████████████████████████████████████████| 739/739 [00:41<00:00, 17.79it/s]"
     ]
    },
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "SCORE: 0.8154957983193276\n",
      "SCORE: 0.7167333333333333\n"
     ]
    },
    {
     "name": "stderr",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "E: tensor(42.1896, device='cuda:0', grad_fn=<MeanBackward0>)\n",
      "T: tensor(16.4834, device='cuda:0', dtype=torch.float64)\n",
      "E: tensor(6.9034, device='cuda:0', grad_fn=<MeanBackward0>)\n",
      "T: tensor(11.0619, device='cuda:0', dtype=torch.float64)\n"
     ]
    }
   ],
   "source": [
