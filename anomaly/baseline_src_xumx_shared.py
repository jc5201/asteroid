...
if __name__ == "__main__":
    ...
    for dir_idx, target_dir in enumerate(dirs):
        ...
        #model_path = '/hdd/hdd1/lyj/xumx/output_w_cont_slider/checkpoints/epoch=998-step=44954.ckpt'
        model_path = '/hdd/hdd1/lyj/xumx/output_w_cont_slider3/checkpoints/epoch=756-step=50718.ckpt'
        ...
        os.makedirs(os.path.join(os.path.join(ae_path, 'shared_ae'), 'id_00_02' ), exist_ok = True)
        ae_path_target = os.path.join(os.path.join(os.path.join(ae_path, 'shared_ae'), 'id_00_02' ), FILE)

        train_dataset = AEDataset(sep_model, train_files, param, target_source=S1)
        train_dataset2 = AEDataset(sep_model, train_files, param, target_source=S2)
        train_dataset.data_vector = numpy.concatenate((train_dataset.data_vector, train_dataset2.data_vector), axis=0)
